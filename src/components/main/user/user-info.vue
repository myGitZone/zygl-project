<template>
  <el-dialog :close-on-click-modal="false" :modal="false" custom-class="dialog-custom-shadow" title="个人中心"
             :visible.sync="showUserInfo" size="tiny">
      ...
      okClick() {
        this.$refs.form.validate((valid) => {
          ...
          if (valid && isUpdate) {
            ...
            params.append('userId', this.cloneUserInfo.userid)
