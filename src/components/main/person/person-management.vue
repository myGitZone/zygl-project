...
<template>
  <div class="person-content">
    <el-row>
      ...
      <el-col :span="4">
        <el-cascader change-on-select v-model="selected" style="line-height: 40px" :props="defaultProps"
                     :options="elCascaderOptions" size="small"></el-cascader>
      </el-col>
    ...
    <el-row ref="table" class="table-content">
      <el-table :data="showTableData" border :height="tableHeight" highlight-current-row style="width: 100%"
                @current-change="currentSelectRowChange">
    ...
    <el-dialog :close-on-click-modal="false" :modal="false" custom-class="dialog-custom-add-edit" title="提示"
               :visible.sync="showDialog" size="small">
      <add-editPerson @cancelClick="cancelClick" @saveClick="saveClick" :userInfo="userInfo"
                      v-if="showDialog"></add-editPerson>
    </el-dialog>
  </div>
</template>
